...
class Fetch_sfda_medicine_fix extends CronBase
{
    ...
    private function getContent ($sfda_id) {
        ...
        while (1 == 1) {
            ...
            echo "\n ----begin----";
            echo $content_ql->getState();
            echo "\n ----middle----";
            echo $content_ql->getHtml();
            echo "\n----end----";
            ...
            $content_data = $content_ql->getData(
                    function  ($content) {
...
$process = new Fetch_sfda_medicine_fix(__FILE__);
$process->dowork();