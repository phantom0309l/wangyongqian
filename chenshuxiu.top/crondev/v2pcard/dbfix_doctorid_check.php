...
class dbfix_three_id_add_pcardid extends DbFixBase
{
...
echo "\n\n-----begin----- " . XDateTime::now();
Debug::trace("=====[cron][beg][dbfix_three_id_add_pcardid.php]=====");

$process = new dbfix_three_id_add_pcardid();
$process->dowork();

Debug::trace("=====[cron][end][dbfix_three_id_add_pcardid.php]=====");
Debug::flushXworklog();
echo "\n-----end----- " . XDateTime::now();
