 ...
 * GameCombatBlcDao
 */
class GameCombatBlcDao extends Dao
{
    // 名称: getAvgTime
    // 备注:
    // 创建:
    ...
    public static function getByGameplayid ($gameplayid) {
        ...
        return Dao::getEntityListByCond("GameCombatBlc", "AND gameplayid = :gameplayid ", $bind);
    }
    ...
    public static function getIsRight ($gameplayid) {
        ...
        return Dao::getEntityListByCond("GameCombatBlc", "AND gameplayid = :gameplayid AND isright = 1", $bind);
    }
}
