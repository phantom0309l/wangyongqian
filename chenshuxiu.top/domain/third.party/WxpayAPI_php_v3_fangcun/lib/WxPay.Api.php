...
class WxPayApi
{
    ...
    public static function notify ($callback, &$msg) {
        ...
        Debug::trace("========== notify_xml ==========");
        Debug::trace($xml);
        Debug::trace("========== notify_xml ==========");

        // 如果返回成功则验证签名 (测试时暂时须注释)
        try {
    ...
    private static function reportCostTime ($url, $startTimeStamp, $data) {
        ...
        // 如果仅失败上报
        if (WxPayConfig::REPORT_LEVENL == 1 && array_key_exists("return_code", $data) && $data["return_code"] == "SUCCESS" &&
    ...
    private static function postXmlCurl ($xml, $url, $useCert = false, $second = 30) {
        ...
        // 运行curl
        $data = curl_exec($ch);
        Debug::trace("========== postXmlCurl_result_xml =========");
        Debug::trace($data);
        Debug::trace("========== postXmlCurl_result_xml =========");
        // 返回结果
        if ($data) {
