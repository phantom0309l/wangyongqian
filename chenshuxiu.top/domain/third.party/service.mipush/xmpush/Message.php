...
class Message
{
    ...
    protected $notify_type; // 通知类型 可组合 (-1 Default_all,1 Default_sound,2
                            // Default_vibrate(震动),4 Default_lights)
    ...
    protected $time_to_send; // 可选项，定时发送消息，用自1970年1月1日以来00:00:00.0
                             // UTC时间表示（以毫秒为单位的时间）。
