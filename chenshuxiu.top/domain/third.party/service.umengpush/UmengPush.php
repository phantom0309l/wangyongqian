...
class UmengPush
{
    ...
    protected $appkey = "562d919a67e58e742c000376";

    protected $appMasterSecret = "iyceqe6obmgcmnndnoteo2z39mgxj5i9";
    ...
    function sendAndroidFilecast () {
        try {
            ...
            $filecast->setPredefinedKeyValue("after_open", "go_app"); // go
                                                                            // to
                                                                            // app
    ...
    public static function push2Ios ($doctorid, $diseaseid, $patientid, $patientname, $pipeid) {
        ...
        $umengPush->sendIOSBroadcast($doctorid, $diseaseid, $patientid, $patientname, $pipeid);
    ...
    function sendIOSBroadcast ($doctorid, $diseaseid, $patientid, $patientname, $pipeid) {
        ...
        try {
            ...
            $brocast->setPredefinedKeyValue("appkey", $this->appkey);
            $brocast->setPredefinedKeyValue("timestamp", $this->timestamp);
            $brocast->setPredefinedKeyValue("alias_type", "doctorid");
            $brocast->setPredefinedKeyValue("alias", $doctorid);

            $brocast->setPredefinedKeyValue("alert", $desc);
            ...
            // Set customized fields
            $brocast->setCustomizedField("diseaseid", $diseaseid);
            $brocast->setCustomizedField("doctorid", $doctorid);
            $brocast->setCustomizedField("patientid", $patientid);
            $brocast->setCustomizedField("patientname", $patientname);
            $brocast->setCustomizedField("pipeid", $pipeid);
