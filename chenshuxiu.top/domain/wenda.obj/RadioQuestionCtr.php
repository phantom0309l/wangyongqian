...
class RadioQuestionCtr extends SingleChoiceQuestionCtr
{

    public function getHtml () {
        return $this->getRadioHtml();
    }
...
INPUTHTML;
    ...
    protected function getRadioHtml () {
        $arr = $this->getXOptionArray4HtmlCtr();
        ...
        $str = HtmlCtr::getRadioCtrImp($arr, $this->getContentInputName(), $this->getTheXOptionIdOfAnswer(), $br, 'sheet-question-radio', $fixs);
...
INPUTHTML;
    ...
    public function getRadioHtml4scale () {
        $arr = $this->getXOptionArray4HtmlCtr();
        $fixs = $this->getXOptionFixArray4HtmlCtr();
        $str = HtmlCtr::getRadioCtrImp($arr, $this->getContentInputName(), $this->getTheXOptionIdOfAnswer(), '', 'sheet-question-radio', $fixs);
