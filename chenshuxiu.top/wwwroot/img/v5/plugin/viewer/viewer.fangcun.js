...
(function (factory) {
  ...
  Viewer.prototype = {
    ...
    init: function () {
      ...
      var $images;
      var imgSelector = SELECTOR_IMG;
      if (typeof options.class != undefined && options.class != '') {
         imgSelector += '.' + options.class;
      }
      var $images = isImg ? $this : $this.find(imgSelector);
    ...
    update: function () {
      ...
      if (this.isImg) {
        ...
        if (!$this.parent().length) {
          ...
          var imgSelector = SELECTOR_IMG;
          if (typeof this.options.class != undefined && this.options.class != '') {
              imgSelector += '.' + this.options.class;
          }
          this.$images = $images = $this.find(imgSelector);
