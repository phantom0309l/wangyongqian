<?php
$pagetitle = "图片归档 PatientPicture";
$cssFiles = [
    $img_uri . "/v5/page/audit/patientpicturemgr/one/one.css?v=20170822",
        ...
        <section class="col-md-6">
            ...
            <div class="block" id="pp_objtype" data-objtype="<?= $typestr_code ?>">
                ...
                <?php foreach( $typestr_code_url_arr as $k => $arr ){?>
                    ...
                    <?php }?>
                <?php }?>
                <li class="pull-right <?php if ($typestr_code == "meanless") {?> active<?php } ?>">
                ...
                <div class="block-content tab-content">
                    <div class="tab-pane active" id="btabs-alt-static-home">
                        <?php if($patientpicture->status < 2){
                            include dirname ( __FILE__ )."/_{$patientpicture->objtype}.php";
                        } else {?>
                        <p class="text-center">已经标记为无意义图片</p>
                        <?php } ?>
                    </div>
                    <p></p>
                </div>
