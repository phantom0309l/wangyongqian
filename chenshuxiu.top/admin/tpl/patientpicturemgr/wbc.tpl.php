        ...
        <section class="col-md-6">
            ...
            <div class="block" id="pp_objtype" data-objtype="<?= $typestr_code ?>">
                ...
                <div class="block-content tab-content">
                    <form action="/patientpicturemgr/wbcpost" method="post" class="form-horizontal myform">
                        ...
                        <div class="form-group">
                            <label class="col-xs-10">白细胞</label>
                                <div class="col-xs-10">
                            <input class="form-control" type="number" name="baixibao" step="0.001" value="<?= $baixibao ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-xs-10">血红蛋白</label>
                            <div class="col-xs-10">
                                <input class="form-control" type="number" name="xuehongdanbai" step="0.001" value="<?= $xuehongdanbai ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-xs-10">血小板</label>
                            <div class="col-xs-10">
                                <input class="form-control" type="number" name="xuexiaoban" step="0.001" value="<?= $xuexiaoban ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-xs-10">中性粒细胞绝对值</label>
                            <div class="col-xs-10">
                                <input class="form-control" type="number" name="zhongxingli" step="0.001" value="<?= $zhongxingli ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-10">
