...
<form action="/scheduletplmgr/modifyPost" method="post">
            ...
            <tr>
                <th colspan="10">
                    ...
                    <div class="alert alert-warning alert-dismissable push-10-t">
                        <h5 class="font-w400">大修一条出诊模板信息</h5>
                    </div>
                </th>
            </tr>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <div class="mt10">
                        <label>门诊周期</label>
                        <?php echo HtmlCtr::getSelectCtrImp(ScheduleTpl::get_op_hzArray(), 'op_hz', $scheduletpl->op_hz,'form-control '); ?>
                    </div>
                </td>
                <td>
                    <?php
                        echo HtmlCtr::getRadioCtrImp4OneUi($show_arr, "is_show_p_wx[op_hz]", $is_show_p_wx['op_hz'] ?? 1);
                    ?>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="mt10">
                        <label>门诊时段</label>
                        <?php echo HtmlCtr::getSelectCtrImp(ScheduleTpl::get_day_partArray(), 'day_part', $scheduletpl->day_part,'form-control '); ?>
                    </div>
                </td>
                <td>
                    <?php
                        echo HtmlCtr::getRadioCtrImp4OneUi($show_arr, "is_show_p_wx[day_part]", $is_show_p_wx['day_part'] ?? 1);
                    ?>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    // }
                    // $begin_time[0] = $begin_time[0] == '-' ? '' : $begin_time[0];
                    // $begin_time[1] = $begin_time[1] == '-' ? '' : $begin_time[1];
                    ?>
            ...
            <tr>
                <td>
                    <div class="mt10">
                        <label>选择最近的门诊出诊时间 (<?= $scheduletpl->get_wday() ?>)</label>
                        <input type="text" class="form-control calendar" name="op_date" value="<?= $scheduletpl->op_date ?>" />
                    </div>
                </td>
                <td>
                    <?php
                        echo HtmlCtr::getRadioCtrImp4OneUi($show_arr, "is_show_p_wx[op_date]", $is_show_p_wx['op_date'] ?? 1);
                    ?>
                </td>
            </tr>
            <tr>
