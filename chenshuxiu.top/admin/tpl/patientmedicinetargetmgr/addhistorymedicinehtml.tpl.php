                ...
                <form class="drugBox drugBox-add">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="drug_frequency">
                            ...
                            <option value="<?= $a ?>" <?php if($a == $pmtarget->drug_frequency){ ?>selected="selected"<?php }?>><?= $a ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="form-group">
...
//                            array_pop($statusDescArray);
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-sm btn-primary addHistoryMedicineSubmitBtn" type="button"><i class="fa fa-check"></i> 提交</button>
        </div>
    </div>
</div>
<script>
