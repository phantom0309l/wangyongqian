<div class="">
    <form class="patientrecord-panel form form-horizontal">
        ...
        <div class="form-group">
            <label class="control-label col-md-2">诊断结果</label>
            <div class="col-md-8">
            <?php echo HtmlCtr::getSelectCtrImp(PatientRecordNMO::getOptionByCode('diagnose'),"diagnose[title]",'待确诊','form-control'); ?>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <a style="line-height:2.2" target='blank' href="/patientrecordmgr/list?patientid=<?= $patient->id ?>&code=nmo&type=diagnose"><i class="fa fa-history"></i> 历史记录</a>
            </div>
        </div>
    </form>
</div>
