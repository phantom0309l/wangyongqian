<div class="">
    <form class="patientrecord-panel form form-horizontal">
        ...
        <input type="hidden" name="type" value="drug_pkg">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
            <input type="text" class="form-control" name="drug_pkg[hospitalname]" value="">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-2">本次</label>
            <div class="col-md-8">
            <input type="text" class="form-control" name="drug_pkg[that]" value="">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <a style="line-height:2.2" target='blank' href="/patientrecordmgr/list?patientid=<?= $patient->id ?>&code=nmo&type=drug_pkg"><i class="fa fa-history"></i> 历史记录</a>
            </div>
        </div>
    </form>
</div>
