<div class="">
    <form class="patientrecord-panel form form-horizontal">
        ...
        <input type="hidden" name="type" value="wbc_treat">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
            <?php echo HtmlCtr::getSelectCtrImp(PatientRecordNMO::getOptionByCode('wbc_treat_type'),"wbc_treat[name]",'停免疫抑制剂','form-control'); ?>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <a style="line-height:2.2" target='blank' href="/patientrecordmgr/list?patientid=<?= $patient->id ?>&code=nmo&type=wbc_treat"><i class="fa fa-history"></i> 历史记录</a>
            </div>
        </div>
    </form>
</div>
