<div class="">
    <form class="patientrecord-panel form form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
            <?php echo HtmlCtr::getSelectCtrImp(array("升白针"=>"升白针","升血小板针"=>"升血小板针"),"wbc_treat[name]",'升白针','form-control'); ?>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <a style="line-height:2.2" target='blank' href="/patientrecordmgr/list?patientid=<?= $patient->id ?>&code=cancer&type=wbc_treat"><i class="fa fa-history"></i> 历史记录</a>
            </div>
        </div>
    </form>
</div>
