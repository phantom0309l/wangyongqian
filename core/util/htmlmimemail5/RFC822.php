...
class Mail_RFC822
{
     ...
     *            Default domain/host etc. If not supplied, will be set to
     *            localhost.
     * @param $nest_groups boolean
     *            Whether to return the structure with groups nested for easier
     *            viewing.
     * @param $validate boolean
     *            Whether to validate atoms. Turn this off if you need to run
     *            addresses through before encoding the personal names, for
     *            instance.
     *
    ...
    function _splitCheck ($parts, $char) {
        ...
        for ($i = 0; $i < count($parts); $i ++) {
            if ($this->_hasUnclosedQuotes($string) || $this->_hasUnclosedBrackets($string, '<>') || $this->_hasUnclosedBrackets($string, '[]') ||
                     $this->_hasUnclosedBrackets($string, '()') || substr($string, - 1) == '\\') {
                        if (isset($parts[$i + 1])) {
             ...
             * @param $string string
             *            The string to check.
             * @return boolean True if there are unclosed quotes inside the
             ...
             * @return boolean True if there are unclosed brackets inside the
             *         string, false otherwise.
             */
             ...
             * @return integer The number of occurences of $char in $string,
             *         adjusted for backslashes.
             */
             ...
             * validateAtom() doesn't actually check anything. This is so that
             * you
             ...
             * @param $route string
             *            The string to check.
             * @return mixed False on failure, or the validated $route on
             *         success.
             */
             ...
             * @param $domain string
             *            The string to check.
             * @return mixed False on failure, or the validated domain on
             *         success.
             */
             ...
             *
             * @access private
             * @param $addr_spec string
             *            The string to check.
             * @return mixed False on failure, or the validated addr-spec on
             *         success.
             */
