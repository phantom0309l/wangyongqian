...
// define('Spreadsheet_Excel_Reader_HAVE_MB',
...
class Spreadsheet_Excel_Reader
{
                    ...
                    if (array_key_exists($indexCode, $this->dateFormats)) {
                        ...
                        if ($indexCode > 0) {
                            if (isset($this->formatRecords[$indexCode]))
                                ...
                                // echo "\ndate-time=$formatstr=\n";
                            if ($formatstr)
                                if (preg_match("/[^hmsday\/\-:\s]/i", $formatstr) == 0) { // found
                                                                                          // day
                                                                                          // and
                                                                                          // time
                                                                                          // format
            ...
            switch ($code) {
                ...
                case Spreadsheet_Excel_Reader_Type_MERGEDCELLS:
                    ...
                    for ($i = 0; $i < $cellRanges; $i ++) {
                        ...
                        // $this->sheets[$this->sn]['mergedCells'][] = array($fr
                        // + 1, $fc + 1, $lr + 1, $lc + 1);
                        if ($lr - $fr > 0) {
                ...
                case Spreadsheet_Excel_Reader_Type_MULRK:
                    ...
                    for ($i = 0; $i < $columns; $i ++) {
                        ...
                        // ord($rec['data'][$pos]) | ord($rec['data'][$pos+1])
                        // << 8;
                        $tmppos += 6;
    ...
    function _GetIEEE754 ($rknum) {
        if (($rknum & 0x02) != 0) {
            ...
            // of the
            // 64 bit floating point value. The other 34 bits are assumed to be
            // 0
