...
class OLERead
{
    ...
    function read ($sFileName) {
        ...
        /*
         * echo $this->numBigBlockDepotBlocks." "; echo $this->sbdStartBlock."
         * "; echo $this->rootStartBlock." "; echo $this->extensionBlock." ";
        ...
        /*
         * while ($block != -2) { $pos = ($block + 1) * BIG_BLOCK_SIZE;
         * $this->entry = $this->entry.substr($this->data, $pos,
         * BIG_BLOCK_SIZE); $block = $this->bigBlockChain[$block]; }
         */
        // echo '==='.$this->entry."===";
