...
class PHPMailer
{
    ...
    public function CreateBody () {
        ...
        if ($this->IsError()) {
            ...
            try {
                $file = tempnam('', 'mail');
                file_put_contents($file, $body); // TOXDO check this worked
    ...
    public function EncodeQPphp ($input = '', $line_max = 76, $space_conv = false) {
        ...
        while (list (, $line) = each($lines)) {
            ...
            for ($i = 0; $i < $linlen; $i ++) {
                $c = substr($line, $i, 1);
                $dec = ord($c);
                if (($i == 0) && ($dec == 46)) { // convert first point in
                                                       // the line into =2E
                    $c = '=2E';
                }
                if ($dec == 32) {
    ...
    public function EncodeQ ($str, $position = 'text') {
        ...
        switch (strtolower($position)) {
            ...
            default:
                ...
                // TOXDO using /e (equivalent to eval()) is probably not a good
                // idea
     ...
     *            set/reset
     * @toxdo Should this not be using __set() magic function?
     */
