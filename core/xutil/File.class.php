...
class File // extends Object
{
     ...
     *
     * @param
     *            size Amount of bytes we'd like to read from the file. It is
     ...
     *
     * @param
     *            data The data that we'd like to write to disk
     ...
     *
     * @param
     *            length Lenght at which we'd like to truncate the file
    ...
    function writeLines ($lines) {
        ...
        foreach ($lines as $line) {
            ...
            /*
             * else print("written: \"".htmlentities($line)."\"<br/>");
             */
        }
    ...
    /**
     * Returns true wether the file is a directory.
     * See
     * http://fi.php.net/manual/en/function.is-dir.php for more details.
     *
     * @param
     *            file The filename we're trying to check. If omitted, the
     *            current file will be used (note that this function can be used
     *            as
     ...
     * Can be used as static if a
     * filename is provided
     *
     * @param
     *            if provided, this method can be used as an static method and
    ...
    /**
     * removes a file.
     * Can be used as static if a filename is provided.
     * Otherwise it will remove the file that was given in the constructor
     *
     * @param
     *            optionally, name of the file to delete
     * @return True if successful or false otherwise
     */
     ...
     *            dirName
     * @param
     *            recursive Whether to recurse through all subdirectories that
     *            are within the given one and remove them.
     * @param
     *            onlyFiles If the recursive mode is enabled, setting this to
     *            'true' will
     *            force the method to only remove files but not folders. The
     *            directory will not be
     *            removed but all the files included it in (and all
     ...
     * If the folder name is /a/b/c and neither
     ...
     *
     * @param
     *            dirName The name of the new folder
     * @param
     *            mode Attributes that will be given to the folder
     ...
     *
     * @param
     *            string fileName An optional parameter specifying the name
     ...
     *
     * @param
     *            inFile The name of the file whose mode we'd like to change
     * @param
     *            mode The new mode, or if none provided, it will default
     *            to 0644
     * @return true if successful or false otherwise
     * @static
     *
     ...
     *
     * @param
     *            fileName optinally, name of the file whose existance we'd
     *            like to check
     * @return true if successful or false otherwise
     */
