 ...
 * @version    CVS: $Id: PEAR.php,v 1.1 2008/08/19 02:37:58 sjp Exp $
...
class PEAR
{
    ...
    function delExpect ($error_code) {
        ...
        if ((is_array($error_code) && (0 != count($error_code)))) {
            ...
            return $deleted ? true : PEAR::raiseError("The expected error you submitted does not exist"); // IMPROVE
                                                                                                          // ME
            ...
            if ($this->_checkDelExpect($error_code)) {
                ...
                return PEAR::raiseError("The expected error you submitted does not exist"); // IMPROVE
                                                                                            // ME
            }
        } else {
            // $error_code is empty
            return PEAR::raiseError("The expected error you submitted is empty"); // IMPROVE
                                                                                  // ME
        }
    }
     ...
     * With this
     * you can easily override the actual error handler for some code and
     * restore
