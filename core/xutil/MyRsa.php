...
class MyRsa
{
	function rsa_encrypt($message, $public_key, $modulus, $keylength)
	{
		...
		echo"<br> padded="; var_dump($padded);

		$number = $this->binary_to_number($padded);
		echo"<br> number="; var_dump($number);

		$encrypted = $this->pow_mod($number, $public_key, $modulus);
		echo"<br> encrypted="; var_dump($encrypted);
	...
	*/
	...
	{
		echo "<br>------pow_mod beg-------<br>p=$p<br>q=$q<br>r=$r<br>";
		...
		echo "<br>power_of_two=";
		var_dump($power_of_two);
		echo "<br>factors=";
		var_dump($factors);
		echo "<br>";
		...
		echo "<br>partial_results=";
		var_dump($partial_results);
		echo "<br>";
